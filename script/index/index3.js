var cambio=0;
$('.flizs').click(function() {
      cambio=2;
});

sltime = setTimeout(function(){ $(".slider-clientes .flecha-derecha2").click(); },2000);
sltime2 = setTimeout(function(){ $(".slider-paquetes .flecha-derecha2").click();  cambio=1 },2000);
...
$("#frmConhom").jform({
    after:function(response){
     window.location="index/graciashome";
        }
});
...
$("#Enviar").click(function(){
    ...
    setTimeout(function(){
            ...
            $form.append($("#usuario").attr("name"), $("#usuario").val());
            $form.append($("#password").attr("name"), $("#password").val());

        $.ajax({
            url: "https://mifactura.com/api/usuarios/authenticate",
            type: "POST",
            contentType:false,
            processData: false,
            cache: true,
            ...
            success: function(response){
                ...
                if(response.success != undefined){
                  ...
                  $.cookie('XCF-FACTURA',response.token , { expires: 7 });
                  window.location.href = "https://mifactura.com/panel/"
            ...
            error:function (xhr, ajaxOptions, thrownError){
                if(xhr.status==404) {
                  App.Alert({"error":"Usuario o contraseña erroneos"});
                }
            }
        });
...
App.connect("app/publicaciones/getdata2sat",false,function(response4){
    $.each(response4,function(index,value4){
        var divA = $('<div class="col-md-6 publicacion"><div class="col-md-12 img"><a href="blog/articulosat/'+value4.url+'"><img src="fileimages/publicaciones/'+value4.img+'"></a></div><div class="col-md-12 titulo"><a href="blog/articulosat/'+value4.url+'">'+value4.titulo+'</a></div><div class="col-md-12 texto">'+value4.previo+'</div></div>');
...
App.connect("app/slider/getdata",false,function(response5){
    ...
    $.each(response5,function(index,value5){
        if (a==0){
            var divA = $('<div class="item active"><img src="fileimages/home/'+value5.img+'"><div class="carousel-caption"></div></div>');
        }
        else{
            var divA = $('<div class="item "><img alt="" src="fileimages/home/'+value5.img+'"><div class="carousel-caption"></div></div>');
        }
...
App.connect("app/paquetes/getdata",false,function(response5){
    ...
    $.each(response5,function(index,value5){
        ...
        var divA = $('<a href="pagfacturacion" ><div class="elemento5 view-first2 v1" style="cursor:pointer;"><div class="paquete"><div class="p1 col-md-12" style="background-color:'+value5.color+'"><div class="col-md-12 titulo">'+nombre+'</div><div class="col-md-12 folios">'+value5.folios+'</div><div class="col-md-12 texto">'+value5.texto+'</div></div><div class="col-md-12 comprar"></div></div></div></a>');
