...
--></style>
      ...
      <li>
        <span class="name">
          ...
          <ul class="dropdown-menu megamenu image-links-layout" role="menu" style="display: none;"></ul>
      </li>
      <li>
        <span class="name">
...
<!-- shopping cart end -->
          ...
          <!-- social media  -->
        <div class="h-address pull-right hidden-sm hidden-xs"><br>
          ...
          <nav class="navbar navbar-inverse">
            <div class="container-fluid">
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  <a class="dropdown-toggle" data-toggle="dropdown" href="#">Nuestras Soluciones
